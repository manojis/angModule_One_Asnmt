...
<html lang="en" class=" is-copy-enabled is-u2f-enabled">
  <head prefix="og: http://ogp.me/ns# fb: http://ogp.me/ns/fb# object: http://ogp.me/ns/object# article: http://ogp.me/ns/article# profile: http://ogp.me/ns/profile#">
    ...
    <link rel="web-socket" href="wss://live.github.com/_sockets/MTQ5NjA1Nzg6ZGJiOGJkMDQ4N2RhZDYyYzUyZDk5YWZkZGY4OWUyMWU6ZTVkMDM2NTZiNjRjNjAzYTRiOTU2NjViMTM0MzBjOGFhOTc4NjUyZWJkYjQ4Njk5ZDk3MTkzMDlhYzQ5ZGZkNQ==--f99c90aa302eb654d12dd5b3f5bf23fdc14a6cfb">
    <meta name="pjax-timeout" content="1000">
    <link rel="sudo-modal" href="/sessions/sudo_modal">
    <meta name="request-id" content="C6A9BCE8:69BD:4076C96:57E0326E" data-pjax-transient>
...
<meta content="collector.githubapp.com" name="octolytics-host" /><meta content="github" name="octolytics-app-id" /><meta content="C6A9BCE8:69BD:4076C96:57E0326E" name="octolytics-dimension-request_id" /><meta content="14960578" name="octolytics-actor-id" /><meta content="manojis" name="octolytics-actor-login" /><meta content="c13de6b243fd30298151802cc37a38dc4533df74e90349d149098d153503de32" name="octolytics-actor-hash" />
<meta content="/&lt;user-name&gt;/&lt;repo-name&gt;/blob/show" data-pjax-transient="true" name="analytics-location" />
  ...
  <meta class="js-ga-set" name="dimension1" content="Logged In">
    ...
    <meta name="user-login" content="manojis">

        <meta name="expected-hostname" content="github.com">
      <meta name="js-proxy-site-detection-payload" content="ZmM4ZGEyODVhNjEwODk4M2ZkNTc0MjI5ZDg4OGE4ZDJjYzhiZmE4YmNkYWQ0YzkzZTMzNmUwYTkyNGIxNjhiY3x7InJlbW90ZV9hZGRyZXNzIjoiMTk4LjE2OS4xODguMjMyIiwicmVxdWVzdF9pZCI6IkM2QTlCQ0U4OjY5QkQ6NDA3NkM5Njo1N0UwMzI2RSIsInRpbWVzdGFtcCI6MTQ3NDMxMDc2Nn0=">


      <link rel="mask-icon" href="https://assets-cdn.github.com/pinned-octocat.svg" color="#4078c0">
      <link rel="icon" type="image/x-icon" href="https://assets-cdn.github.com/favicon.ico">

    <meta name="html-safe-nonce" content="b0f9b43fea9e3831d3ceeea50cf6600121b37e02">
    <meta content="09ebf5fefc866a0a61c7173bbf2349d3bed7c3cd" name="form-nonce" />
...
<ul class="header-nav user-nav float-right" id="user-links">
  <li class="header-nav-item">
    ...
    <a href="/notifications" aria-label="You have no unread notifications" class="header-nav-link notification-indicator tooltipped tooltipped-s js-socket-channel js-notification-indicator" data-channel="tenant:1:notification-changed:14960578" data-ga-click="Header, go to notifications, icon:read" data-hotkey="g n">
...
<a class="dropdown-item" href="/new" data-ga-click="Header, create new repository">
  ...
  <li class="header-nav-item dropdown js-menu-container">
    <a class="header-nav-link name tooltipped tooltipped-sw js-menu-target" href="/manojis"
       aria-label="View profile and more"
       data-ga-click="Header, show menu, icon:avatar">
      <img alt="@manojis" class="avatar" height="20" src="https://avatars0.githubusercontent.com/u/14960578?v=3&amp;s=40" width="20" />
      <span class="dropdown-caret"></span>
    </a>
    ...
    <div class="dropdown-menu-content js-menu-content">
      <div class="dropdown-menu dropdown-menu-sw">
        <div class="dropdown-header header-nav-current-user css-truncate">
          Signed in as <strong class="css-truncate-target">manojis</strong>
        </div>

        <div class="dropdown-divider"></div>

        <a class="dropdown-item" href="/manojis" data-ga-click="Header, go to profile, text:your profile">
          Your profile
        </a>
          <a class="dropdown-item" href="/manojis?tab=stars" data-ga-click="Header, go to starred repos, text:your stars">
            Your stars
          </a>
        ...
        <!-- </textarea> --><!-- '"` --><form accept-charset="UTF-8" action="/logout" class="logout-form" data-form-nonce="09ebf5fefc866a0a61c7173bbf2349d3bed7c3cd" method="post"><div style="margin:0;padding:0;display:inline"><input name="utf8" type="hidden" value="&#x2713;" /><input name="authenticity_token" type="hidden" value="TlHsn3fzr/3kAeMeOUgRnPiuVvMrnC+xClwHSiMKA38wm5CgyjEyIIRaFASS1+qKG0+eLb2tmC2vU1458Tj8zg==" /></div>
...
<ul class="pagehead-actions">
  ...
  <li>
        <!-- </textarea> --><!-- '"` --><form accept-charset="UTF-8" action="/notifications/subscribe" class="js-social-container" data-autosubmit="true" data-form-nonce="09ebf5fefc866a0a61c7173bbf2349d3bed7c3cd" data-remote="true" method="post"><div style="margin:0;padding:0;display:inline"><input name="utf8" type="hidden" value="&#x2713;" /><input name="authenticity_token" type="hidden" value="VPAiU7P9Uh0rf7sW4VVPsfsk7R6x1B9frw2q6TbGwlUREkMizX//+OzB4TpWSCuhyOCicSO3lhevpKDWN1tzfQ==" /></div>      <input class="form-control" id="repository_id" name="repository_id" type="hidden" value="66777429" />
  ...
  <div class="js-toggler-container js-social-container starring-container ">
    ...
    <!-- </textarea> --><!-- '"` --><form accept-charset="UTF-8" action="/jhu-ep-coursera/fullstack-course5/unstar" class="starred" data-form-nonce="09ebf5fefc866a0a61c7173bbf2349d3bed7c3cd" data-remote="true" method="post"><div style="margin:0;padding:0;display:inline"><input name="utf8" type="hidden" value="&#x2713;" /><input name="authenticity_token" type="hidden" value="YAjkpo7xbi0ZjLAzttOCWBXwnb2dNc8G9up2KQoefSrrpVkx7r/iVtu07jo5SpufuFfQ9qpwiZAodWyW0m5SmQ==" /></div>
      <button
    ...
    <!-- </textarea> --><!-- '"` --><form accept-charset="UTF-8" action="/jhu-ep-coursera/fullstack-course5/star" class="unstarred" data-form-nonce="09ebf5fefc866a0a61c7173bbf2349d3bed7c3cd" data-remote="true" method="post"><div style="margin:0;padding:0;display:inline"><input name="utf8" type="hidden" value="&#x2713;" /><input name="authenticity_token" type="hidden" value="WQgHBm6Fyyi8ZFwG5rfCwSuPGO5ySrN4JDLt9xYlS/TO/MS6TFRZ0Qe4uqd+xTleNlgT6sUWLEtHbhZ5IWPTSw==" /></div>
      <button
        class="btn btn-sm btn-with-count js-toggler-target"
  ...
  <li>
          <!-- </textarea> --><!-- '"` --><form accept-charset="UTF-8" action="/jhu-ep-coursera/fullstack-course5/fork" class="btn-with-count" data-form-nonce="09ebf5fefc866a0a61c7173bbf2349d3bed7c3cd" method="post"><div style="margin:0;padding:0;display:inline"><input name="utf8" type="hidden" value="&#x2713;" /><input name="authenticity_token" type="hidden" value="u+tCiO3VmvtFPT2uXCWgb7TIiI6YQi5QIo9FSPe54BG/gC+w14BdXz5I3NYT+rLl0HXxuOKpuwLoqIk7aga3FQ==" /></div>
            <button
                type="submit"
    ...
    <a href="/jhu-ep-coursera/fullstack-course5/network" class="social-count"
       aria-label="150 users are forked this repository">
      150
    </a>
  </li>
</ul>
...
<a href="/jhu-ep-coursera/fullstack-course5/blob/d0ac3370d4501c8f477891a45fc0dcf6c3cfa591/assignments/assignment1/Assignment-1.md" class="d-none js-permalink-shortcut" data-hotkey="y">Permalink</a>

<!-- blob contrib key: blob_contributors:v21:db1e898e0a3d1b7e72db661fc5c897b8 -->
...
<div class="select-menu branch-select-menu js-menu-container js-select-menu float-left">
  ...
  <div class="commit-tease">
      <span class="float-right">
        <a class="commit-tease-sha" href="/jhu-ep-coursera/fullstack-course5/commit/11ce95fc2cc2c238ea33dbeadd8a187d93277174" data-pjax>
          11ce95f
        </a>
        <relative-time datetime="2016-09-14T09:42:42Z">Sep 14, 2016</relative-time>
      </span>
      <div>
        ...
        <a href="/ychaikin" class="user-mention" rel="contributor">ychaikin</a>
          <a href="/jhu-ep-coursera/fullstack-course5/commit/11ce95fc2cc2c238ea33dbeadd8a187d93277174" class="message" data-pjax="true" title="Assignment 2 and some corrections to assignment 1.">Assignment 2 and some corrections to assignment 1.</a>
      </div>
  ...
  <div class="file-actions">
    ...
    <div class="BtnGroup">
      ...
      <a href="/jhu-ep-coursera/fullstack-course5/commits/master/assignments/assignment1/Assignment-1.md" class="btn btn-sm BtnGroup-item" rel="nofollow">History</a>
        ...
        <!-- </textarea> --><!-- '"` --><form accept-charset="UTF-8" action="/jhu-ep-coursera/fullstack-course5/edit/master/assignments/assignment1/Assignment-1.md" class="inline-form js-update-url-with-hash" data-form-nonce="09ebf5fefc866a0a61c7173bbf2349d3bed7c3cd" method="post"><div style="margin:0;padding:0;display:inline"><input name="utf8" type="hidden" value="&#x2713;" /><input name="authenticity_token" type="hidden" value="7lo6Elycnfed/nWhbJIYc2apqvVN4qwRN9r0lrgDszfE4Z/5UM8o5w9xVD5TPn3Cy3QImKwE0ej4CWTB5plBeg==" /></div>
          <button class="btn-octicon tooltipped tooltipped-nw" type="submit"
            aria-label="Fork this project and edit the file" data-hotkey="e" data-disable-with>
            <svg aria-hidden="true" class="octicon octicon-pencil" height="16" version="1.1" viewBox="0 0 14 16" width="14"><path d="M0 12v3h3l8-8-3-3-8 8zm3 2H1v-2h1v1h1v1zm10.3-9.3L12 6 9 3l1.3-1.3a.996.996 0 0 1 1.41 0l1.59 1.59c.39.39.39 1.02 0 1.41z"></path></svg>
          </button>
</form>        <!-- </textarea> --><!-- '"` --><form accept-charset="UTF-8" action="/jhu-ep-coursera/fullstack-course5/delete/master/assignments/assignment1/Assignment-1.md" class="inline-form" data-form-nonce="09ebf5fefc866a0a61c7173bbf2349d3bed7c3cd" method="post"><div style="margin:0;padding:0;display:inline"><input name="utf8" type="hidden" value="&#x2713;" /><input name="authenticity_token" type="hidden" value="t5ws/liktQkUqAmOacxCIC/xXWVRg9M78fKyYs7xpp9d/FzCLYvFk8n9UNVp+cZNIo4L5ohAP5W75mHjXgyIXg==" /></div>
...
<p>It should take about an 1 hour or less.</p>
...
<div id="jump-to-line" style="display:none">
  ...
  <div class="site-footer" role="contentinfo">
    ...
    <ul class="site-footer-links">
      <li>&copy; 2016 <span title="0.18794s from github-fe-f06f8d5.cp1-iad.github.net">GitHub</span>, Inc.</li>
